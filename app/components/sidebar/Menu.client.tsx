      ...
      >
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              ...
              <button
                ...
                aria-label={selectionMode ? 'Salir del modo selección' : 'Entrar al modo selección'}
              >
          ...
          <div className="flex items-center justify-between text-sm px-4 py-2">
            <div className="font-medium text-gray-600 dark:text-gray-400">Tus proyectos</div>
            {selectionMode && (
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="sm" onClick={selectAll}>
                  {selectedItems.length === filteredList.length ? 'Quitar selección' : 'Seleccionar todo'}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
          ...
          <div className="flex-1 overflow-auto px-3 pb-3">
            {filteredList.length === 0 && (
              <div className="px-4 text-gray-500 dark:text-gray-400 text-sm">
                {list.length === 0 ? 'Todavía no has construido nada' : 'Sin resultados'}
              </div>
            )}
                ...
                {dialogContent?.type === 'delete' && (
                  <>
                    <div className="p-6 bg-white dark:bg-gray-950">
                      <DialogTitle className="text-gray-900 dark:text-white">¿Eliminar proyecto?</DialogTitle>
                    ...
                    <div className="p-6 bg-white dark:bg-gray-950">
                      ...
                      <DialogDescription className="mt-2 text-gray-600 dark:text-gray-400">
                        <p>
                          ...
                          {dialogContent.items.length === 1 ? 'proyecto' : 'proyectos'}:
                        </p>
